...
abstract class ConvergeAbstractRequest extends \Omnipay\Common\Message\AbstractRequest
{
    ...
    public function getSslCustomerCode()
    {
        return $this->getParameter('ssl_customer_code');
    }

     public function setSslCustomerCode($value)
    {
        return $this->setParameter('ssl_customer_code', $value);
    } 
    ...
    protected function getBaseData()
    {
        $data = array(
            ...
            'ssl_customer_code' => $this->getSslCustomerCode(),
        );
